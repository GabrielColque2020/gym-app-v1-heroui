...
import { RoutineHeader, RoutineSaveSheet } from "@/features/role/student/routine/components/shared";
import { useRoutineSession } from "@/features/role/student/routine/hooks/useRoutineSession";
import { useSaveStudentRoutineSession } from "@/features/role/student/routine/hooks/useRoutineSessionMutations";
import { useStudentRoutineSession } from "@/features/role/student/routine/hooks/useStudentRoutineSession";
import { mapStudentRoutineSessionToSaveInput, type StudentRoutineSession } from "@/features/routine/services/routine-session";
import type { RoutineSaveSummaryItem } from "@/features/role/student/routine/components/shared/RoutineSaveSheet";
		...
		return (
			<Card className={ "border border-danger/20 bg-surface" } variant={ "default" }>
				<Card.Content className={ "flex min-h-40 flex-col items-center justify-center gap-3 py-8 text-center" }>
					...
					<Button className={ "mt-1" } onPress={ () => refetch() }>Reintentar</Button>
				</Card.Content>
			</Card>
		);
	}
