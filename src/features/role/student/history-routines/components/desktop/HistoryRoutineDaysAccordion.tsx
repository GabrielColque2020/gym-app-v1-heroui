...
import { formatHistoryDate } from "@/features/role/student/history-routines/services/history-routines-form";
import { getHistoryRoutineDayStatus } from "@/features/role/student/history-routines/services/history-routines-view";
import { HistoryRoutineExerciseCarousel } from "@/features/role/student/history-routines/components/shared/HistoryRoutineExerciseCarousel";

type HistoryRoutineDaysAccordionProps = {
	days: StudentHistoryRoutine[];
};

function getDayExerciseCount( day: StudentHistoryRoutine ) {
	return day.exercises.length;
}

function getDaySetCount( day: StudentHistoryRoutine ) {
