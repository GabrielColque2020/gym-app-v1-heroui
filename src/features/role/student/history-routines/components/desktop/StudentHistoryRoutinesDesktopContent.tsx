...
import { HistoryRoutineWeeksSelector } from "@/features/role/student/history-routines/components/desktop/HistoryRoutineWeeksSelector";

type StudentHistoryRoutinesDesktopContentProps = {
	monthLabel: string;
