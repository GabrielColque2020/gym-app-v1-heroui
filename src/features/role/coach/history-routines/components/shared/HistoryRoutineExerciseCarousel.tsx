...
import { HistoryRoutineExerciseCard } from "@/features/role/coach/history-routines/components/desktop/HistoryRoutineExerciseCard";

type HistoryRoutineExerciseCarouselProps = {
	exercises: CoachHistoryRoutine["exercises"];
};
