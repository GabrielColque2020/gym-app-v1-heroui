...
import { formatHistoryDate } from "@/features/role/coach/history-routines/services/history-routines-form";
import { getHistoryRoutineDayStatus } from "@/features/role/coach/history-routines/services/history-routines-view";
import { HistoryRoutineExerciseCarousel } from "@/features/role/coach/history-routines/components/shared/history-routine-exercise-carousel";

type HistoryRoutineDaysAccordionProps = {
	days: CoachHistoryRoutine[];
};

function getDayExerciseCount( day: CoachHistoryRoutine ) {
	return day.exercises.length;
}

function getDaySetCount( day: CoachHistoryRoutine ) {
