...
import { CoachCopyRoutineSummaryRow } from "@/features/role/coach/training-routine/components/shared/coach-copy-routine-sheet-elements";

type CoachCopyRoutineSheetSummaryPanelProps = {
	destLabel: string;
...
export function CoachCopyRoutineSheetSummaryPanel( {
	destLabel,
	...
	sourceLabel,
}: CoachCopyRoutineSheetSummaryPanelProps ) {
	return (
