...
import { CoachDeleteRoutineSheet } from "@/features/role/coach/training-routine/components/shared/CoachDeleteRoutineSheet";
import { CoachCreateRoutineSheet } from "@/features/role/coach/training-routine/components/shared/CoachCreateRoutineSheet";
...
export function CoachTrainingRoutineFilter( {
	...
	function handleSearch() {
		...
		router.replace( `/coach/trainingRoutine?${ params.toString() }` );
	}
