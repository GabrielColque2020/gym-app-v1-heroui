...
import { useMealPlansStudentsList } from "@/features/role/coach/meal-plans-students/hooks/useMealPlansStudentsList";
			...
			<Card.Content className={ "py-1" }>
				<div className={ "grid grid-cols-[4rem_1fr_auto] items-start gap-3" }>
					...
					<Button
						...
						variant={ "ghost" }
						onPress={ () => router.push( `/coach/mealPlans?studentId=${ student.id }` ) }
					>
