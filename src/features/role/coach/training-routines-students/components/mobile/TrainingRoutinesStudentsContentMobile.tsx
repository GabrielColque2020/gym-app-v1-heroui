...
import { useTrainingRoutinesStudentsList } from "@/features/role/coach/training-routines-students/hooks/useTrainingRoutinesStudentsList";
			...
			<Card.Content className={ "py-1" }>
				<div className={ "grid grid-cols-[4rem_1fr_auto] items-start gap-3" }>
					...
					<Button
						...
						variant={ "ghost" }
						onPress={ () => router.push( `/coach/trainingRoutine?studentId=${ student.id }` ) }
					>
