...
import { MealPlanDeleteSheet } from "@/features/role/coach/meal-plans/components/shared/MealPlanDeleteSheet";
import { MealPlanSheet } from "@/features/role/coach/meal-plans/components/shared/MealPlanSheet";
...
function MealPlansPageContentLoaded( { studentId }: { studentId: string } ) {
	...
	const breadcrumbs = [
		{ href: "/", label: "Inicio" },
		{ href: "/coach/mealPlansStudents", label: "Planes alimenticios por estudiante" },
	...
	if (isLoading) {
		return (
			<>
				<div className={ "mb-0" }>
					<PageBreadcrumbs
						backHref={ "/coach/mealPlansStudents" }
