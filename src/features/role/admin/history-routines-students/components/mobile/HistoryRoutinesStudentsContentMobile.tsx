...
import type { HistoryRoutinesStudentListItem } from "@/features/role/admin/history-routines-students/actions/get-history-routines-students";
...
import { useHistoryRoutinesStudentsList } from "@/features/role/admin/history-routines-students/hooks/useHistoryRoutinesStudentsList";
			...
			<Card.Content className={ "py-1" }>
				<div className={ "grid grid-cols-[4rem_1fr_auto] items-start gap-3" }>
					...
					<Button
						...
						variant={ "ghost" }
						onPress={ () => router.push( `/admin/historyRoutines?studentId=${ student.id }` ) }
					>
