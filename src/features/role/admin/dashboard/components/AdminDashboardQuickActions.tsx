...
import { ADMIN_DASHBOARD_QUICK_ACTIONS } from "@/features/role/admin/dashboard/services/admin-dashboard-links";
					...
					{ ADMIN_DASHBOARD_QUICK_ACTIONS.map( ( action ) => {
						...
						return (
							<Button
								...
								className={ "h-10 shrink-0 rounded-md px-3 xl:flex-1" }
								variant={ "secondary" }
