...
} from "@/features/role/admin/dashboard/services/admin-dashboard-links";

type AdminDashboardStudentRowActionsProps = {
	student: AdminDashboardStudentSummary;
};

export function AdminDashboardStudentRowActions( { student }: AdminDashboardStudentRowActionsProps ) {
