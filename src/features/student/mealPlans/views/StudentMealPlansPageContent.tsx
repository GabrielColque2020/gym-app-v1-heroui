...
import type { StudentMealPlan } from "@/features/student/mealPlans/actions/get-meal-plans-by-student";
import { useMealPlans } from "@/features/student/mealPlans/hooks/useMealPlans";
import { formatMealPlanDescriptionLines, formatMealTime } from "@/features/admin/mealPlans/services/meal-plans-form";

type StudentMealPlansPageContentProps = {
		...
		return (
			<Alert className={ "border border-warning/20" } status={ "warning" }>
				<Alert.Content>
					...
					<Alert.Description>
						No se pudo identificar tu cuenta para mostrar tus planes alimenticios.
					</Alert.Description>
				</Alert.Content>
			</Alert>
		);
