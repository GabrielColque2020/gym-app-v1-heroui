...
export default function RoutineSaveSheet( {
	...
	return (
		<Sheet isDetached isOpen={ isOpen } placement={ placement } onOpenChange={ onOpenChange }>
			<Sheet.Backdrop variant={ "opaque" }>
				<Sheet.Content className={ placement === "right" ? "w-full max-w-[92vw] sm:w-md" : "w-full max-h-[90vh]" }>
