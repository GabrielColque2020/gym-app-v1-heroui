...
export default function TrainingRoutinesPageContent() {
	...
	return (
		<>
			...
			<Card className={ "w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 " }>

				<Card className={ "w-full items-stretch md:flex-row border-l-4 border-accent shadow-sm" }>
					<div className={ "flex flex-1 flex-col gap-3" }>
						<Card.Header className={ "gap-1 " }>
							<Card.Title className={ "pr-8" }>
								<Typography type={ "h4" } weight={ "bold" }>Dia 1</Typography>
								<Chip
									color={ "success" }
									variant={ "soft" }
				...
				<Card className={ "w-full items-stretch md:flex-row border-l-4 border-accent shadow-sm" }>
					<div className={ "flex flex-1 flex-col gap-3" }>
						<Card.Header className={ "gap-1" }>
							<Card.Title className={ "pr-8" }>
								<Typography type={ "h4" } weight={ "bold" }>Dia 2</Typography>
								<Chip
									color={ "success" }
									variant={ "soft" }
									className={ "absolute top-2 right-4 z-10" }
				...
				<Card className={ "w-full items-stretch md:flex-row border-l-4 border-accent shadow-sm" }>
					<div className={ "flex flex-1 flex-col gap-3" }>
						<Card.Header className={ "gap-1" }>
							<Card.Title className={ "pr-8" }>
								<Typography type={ "h4" } weight={ "bold" }>Dia 3</Typography>
								<Chip
									color={ "success" }
									variant={ "soft" }
									className={ "absolute top-2 right-4 z-10" }
				...
				<Card className={ "w-full items-stretch md:flex-row border-l-4 border-accent shadow-sm" }>
					<div className={ "flex flex-1 flex-col gap-3" }>
						<Card.Header className={ "gap-1" }>
							<Card.Title className={ "pr-8" }>
								<Typography type={ "h4" } weight={ "bold" }>Dia 4</Typography>
								<Chip
									color={ "success" }
									variant={ "soft" }
									className={ "absolute top-2 right-4 z-10" }
				...
				<Card className={ "w-full items-stretch md:flex-row border-l-4 border-accent shadow-sm" }>
					<div className={ "flex flex-1 flex-col gap-3" }>
						<Card.Header className={ "gap-1" }>
							<Card.Title className={ "pr-8" }>
								<Typography type={ "h4" } weight={ "bold" }>Dia 5</Typography>
								<Chip
									color={ "success" }
									variant={ "soft" }
									className={ "absolute top-2 right-4 z-10" }
