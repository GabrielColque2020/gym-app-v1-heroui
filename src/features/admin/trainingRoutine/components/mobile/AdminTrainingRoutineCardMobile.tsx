...
import { Card, Chip, Description, Label, ScrollShadow, Typography } from "@heroui/react";
			...
			<Card.Content className={ "flex flex-col gap-4 pb-4" }>
				<div className={ "grid gap-2" }>
					...
					<ScrollShadow hideScrollBar orientation={ "horizontal" }>
						<RadioButtonGroup
							className={ "flex w-full gap-2 [--radio-button-group-item-radius:0.75rem] px-0.5 py-1" }
