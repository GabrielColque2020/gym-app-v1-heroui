...
export function AdminDeleteRoutineAction( {
											  month,
											  routines,
											  studentId,
											  studentName,
	...
	return (
		<>
			...
			<Sheet isDetached isOpen={ isConfirmOpen } placement={ "right" } onOpenChange={ setIsConfirmOpen }>
				<Sheet.Backdrop variant={ "opaque" }>
					<Sheet.Content className={ "w-115" }>
