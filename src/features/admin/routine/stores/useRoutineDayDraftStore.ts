...
import type { DayExercise } from "@/features/admin/routine/services/routine-day-editor";
...
} from "@/features/admin/routine/services/routine-day-editor";
...
export function ensureRoutineDayDraft( routineDayId: string, routines: AdminRoutineDayExercise[] ) {
