...
export async function getHistoryRoutinesStudentsAction() {
	try {
...
export type HistoryRoutinesStudentListItem = Awaited<ReturnType<typeof getHistoryRoutinesStudentsAction>>[ number ];
