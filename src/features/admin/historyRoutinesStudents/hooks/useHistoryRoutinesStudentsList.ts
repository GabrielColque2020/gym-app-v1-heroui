...
import type { HistoryRoutinesStudentListItem } from "@/features/admin/historyRoutinesStudents/actions/get-history-routines-students";

import { useMemo, useState } from "react";

import { usePagination } from "@/components/common";
import { normalizeSearchValue } from "@/features/admin/user/student/services/student-form";

const ITEMS_PER_PAGE = 5;

type UseHistoryRoutinesStudentsListOptions = {
	students: HistoryRoutinesStudentListItem[];
};

export function useHistoryRoutinesStudentsList( { students }: UseHistoryRoutinesStudentsListOptions ) {
