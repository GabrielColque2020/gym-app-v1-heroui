...
import type { AdminMealPlan } from "@/features/admin/mealPlans/actions/get-meal-plans-by-student";
import { MealPlanDeleteSheet } from "@/features/admin/mealPlans/components/shared/MealPlanDeleteSheet";
import { MealPlanSheet } from "@/features/admin/mealPlans/components/shared/MealPlanSheet";
import { formatMealPlanDescriptionLines, formatMealTime } from "@/features/admin/mealPlans/services/meal-plans-form";
import { useMealPlans } from "@/features/admin/mealPlans/hooks/useMealPlans";

type AdminMealPlansPageContentProps = {
	...
	if (isLoading) {
		return (
			<>
				<div className={ "mb-0" }>
					<PageBreadcrumbs
						backHref={ "/admin/mealPlansStudents" }
...
export default function AdminMealPlansPageContent( { studentId }: AdminMealPlansPageContentProps ) {
	if (!studentId) {
		const breadcrumbs = [
			{ href: "/", label: "Inicio" },
			{ href: "/admin/mealPlansStudents", label: "Planes alimenticios por estudiante" },
