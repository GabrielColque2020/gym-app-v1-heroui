...
import type { GenderFormValue, StudentFormValues } from "@/features/admin/user/student/services/student-form";
...
import {
	useCreateStudent,
	useUpdateStudent,
} from "@/features/admin/user/student/hooks/useStudents";
import {
	GENDER_OPTIONS,
	NO_GENDER,
...
export function StudentFormSheet( props: StudentFormSheetProps ) {
		...
		<>
			...
			<Sheet isDetached isOpen={ isOpen } placement={ placement } onOpenChange={ handleOpenChange }>
				<Sheet.Backdrop variant={ "opaque" }>
					<Sheet.Content className={ placement === "right" ? "w-125" : "mx-auto max-w-125" }>
								...
								<Sheet.Body className={ "min-h-0 flex-1 space-y-6 overflow-y-auto px-6 py-5" }>
									...
									<section className={ "space-y-4" }>
										...
										>
											...
											/>
											{ isPasswordInvalid ?
												<FieldError>La contrasenia es obligatoria.</FieldError> : null }
										</TextField>
									...
									<section className={ "space-y-4 border-t border-border pt-5" }>
										...
										<div className={ "grid gap-4 sm:grid-cols-2" }>
											...
											>
												...
												{ isHeightInvalid ?
													<FieldError>Debe ser mayor o igual a 0.</FieldError> : null }
											</TextField>
